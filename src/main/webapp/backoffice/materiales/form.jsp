	...
	<form action="backoffice/materiales" method="post">
	  ...
	  <div class="input-group ">
	    ...
	    <div class="input-group-append">
	      <input type="number" class="form-control" value="${material.precio}" name="precio" placeholder="Introduce el precio">
	...
	<br>  
		...
		<c:if test="${material.id > -1}">  
			  <div class="form-group row">
			    ...
			    <div class="col-sm-6">			      
			      <a href="backoffice/materiales?id=${material.id}&op=<%=MaterialesBackofficeController.OP_ELIMINAR%>" 
